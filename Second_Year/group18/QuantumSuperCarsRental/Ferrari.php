...
<div id="content">
	<?php
		...
		$sql = mysql_query("Select Make, Model, RentPrice, TopSpeed, Engine, CarDescription, RegNo from car where RegNo = '131-D-1337'");
		...
		while ($row = mysql_fetch_row($sql)) 
		{
			...
			echo ('<img src="Images/Ferrari-F12berlinette.jpg"/>');
