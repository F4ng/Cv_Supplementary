...
<div id="content">
	<?php
		...
		$sql = mysql_query("Select Make, Model, RentPrice, TopSpeed, Engine, CarDescription, RegNo from car where Make = 'Koenigsegg'");
		...
		while ($row = mysql_fetch_row($sql)) 
		{
			...
			echo ('<img src="Images/Koenigsegg-Agera.jpg"/>');
