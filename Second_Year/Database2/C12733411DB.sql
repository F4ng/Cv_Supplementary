...
DROP TABLE Club CASCADE CONSTRAINTS PURGE; 													/* The drop tables are used incase there is an istance of the table already made, this will remove it so that new tables can be made*/
...
(
	...
	ClubHouse            VARCHAR2(20) NOT NULL ,
	ClubManagerName      VARCHAR2(20) NOT NULL ,
	ClubHomeGround       VARCHAR2(20) NOT NULL ,
	ClubDirections       VARCHAR2(150) NOT NULL ,
CONSTRAINT  XPKClub PRIMARY KEY (Club_ID)													/* As Club id has a primary key constraint, this means it is unique   */
);

CREATE TABLE Competition																	/* This Creates the competition table */
(
	Competition_ID       INTEGER NOT NULL ,
	Sponsor              VARCHAR2(20) NOT NULL ,
	AgeGroup             INTEGER NOT NULL ,
	Fee                  INTEGER NOT NULL ,
	Prize                VARCHAR2(20) NOT NULL ,
	OrganisersName       VARCHAR2(20) NOT NULL ,  											/* I choose Not Null for most of these, because the information should be required or the runnning of the competitions would have seroius issues.*/
...
(
	...
	RefName              VARCHAR2(20) NOT NULL ,
	RefPhone             INTEGER NOT NULL ,
	RefAddress           VARCHAR2(20) NOT NULL ,
...
(
	...
	Ref_ID               INTEGER NOT NULL ,
	Competition_ID       INTEGER NOT NULL ,
	MatchVenue           VARCHAR2(20) NOT NULL ,
	MatchDate            VARCHAR2(20) NOT NULL ,
...
CONSTRAINT R_14 FOREIGN KEY (AwayTeam) REFERENCES Team (Team_ID)													/*here we used the same primary key " Team_ID " to make two foreign Kets "hometeam and awayteam". This is done because for every match we want two diffrent instances of team in the match table*/
);
...
(
	...
	Team_ID              INTEGER NOT NULL ,
	PlayerDOB            VARCHAR2(20) NOT NULL ,
	PlayerName           VARCHAR2(20) NOT NULL ,
	PlayerAddress        VARCHAR2(20) NOT NULL ,
	PlayerGaurdian       VARCHAR2(20) NOT NULL ,
...
Delete Result;                                                                                                            /* this deletes all information stored in the result table, this is useful incase data is duplicated, and helps to make things run smothly*/
Delete match;                             
Delete referee;
Delete Player;
Delete Manager;
...
/* Enters infomation about Competitions that will be run*/
INSERT INTO COMPETITION (Competition_ID, Sponsor, AgeGroup, Fee, Prize, OrganisersName, OrganisersNumber)VALUES (201, 'UEFA', '15', '10000', 'Champions League Trophy U15','Sep Blatter', '872549123');				/*data is added into the tables here, the atriubte in witch it is to be added is on the left and the value is set on the right*/
...
/* The clubs that are in our world*/
...
/*Under 15's Team's -These are all the teams that can play in the under 15s competitions*/
...
/*Under 12's Teams -These are all the teams that can play in the under 12s competitions*/
...
/*Under 16's Teams -These are all the teams that can play in the under 16s competitions*/
...
/* This is the where the match data is added to the match table*/
...
/* The results of the matches are recored here*/
INSERT INTO Result (RESULT_ID,MATCH_ID,HOMETEAMSCORE, AWAYTEAMSCORE)VALUES(501,601,2,0); 
